function [bestmem,bestval,nfeval] = differential_evolution(fname,VTR,D,XVmin,XVmax,y,NP,itermax,F,CR,strategy,refresh);
...
err=[];
if nargin<1, error('de 1st argument must be function name'); else 
...
if length(err)>0
  ...
  usage('de (string,scalar,scalar,vector,vector,any,integer,integer,scalar,scalar,integer,integer)');    	
end
...
%----Output section----------------------------------------------------------
  ...
  worst=max(tempfun);
  bestr(iter,:)=[iter bestval];
  fprintf(1,' ===============================================================================================================\n');
  fprintf(1,'                                               Objective Function \n');
  fprintf(1,' ===============================================================================================================\n');
  if (refresh > 0)
       fprintf(1,'  Iteration: %d,    Best Value: %.11f,  Average: %.11f,  Worst: %.11f\n',iter,bestval,average,worst);
       for n=1:D
         fprintf(1,'           x(%d) = %f',n,bestmem(n));
       end
     fprintf(1,'\n');
  end
