function params = Airfoil2DOF()
    ...
    fHeave =  8.90;		% [Hz] Heave uncopled natural frequency
    ...
    % Output parameters
    params.omegaHeave = omegaHeave;
    params.omegaTheta = omegaTheta;
    params.omegaBeta  = omegaBeta;
    params.b = b;
    params.a = a;
    params.e = e;
    params.Mqq = M(1:2,1:2);
    params.Dqq = C(1:2,1:2);
    params.Kqq = K(1:2,1:2);
    params.Mqc = M(1:2,end);
    params.nDOF = 2;
    params.V_OLF = 1145;
